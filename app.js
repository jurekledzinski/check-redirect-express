...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self' firebasestorage.googleapis.com *.firebasestorage.googleapis.com mongodb.com *.mongodb.com paypal.com *.paypal.com; img-src 'self' data;font-src *; object-src 'self';script-src 'sha256-muinbbhYT4ByGcX7i9h85DyS1kl3Gt7qraXrucPlmEA=';style-src 'sha256-ljc5fltBOFUDnSZXPgDc8UORNk+LhgPmVXg4AiMAShc=' fontawesome.com *.fontawesome.com fonts.google.com  *.fonts.google.com fonts.googleapis.com *.fonts.googleapis.com;"
  );
  next();
});
