...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self' firebasestorage.googleapis.com *.firebasestorage.googleapis.com mongodb.com *.mongodb.com ; img-src 'self' * data;font-src *; object-src 'self';script-src 'self' paypal.com *.paypal.com;style-src 'self' fontawesome.com *.fontawesome.com fonts.google.com  *.fonts.google.com fonts.googleapis.com *.fonts.googleapis.com;"
  );
  next();
});
