...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self' firebasestorage.googleapis.com *.firebasestorage.googleapis.com mongodb.com *.mongodb.com paypal.com *.paypal.com; img-src 'self' * data data:image/svg+xml;font-src *; object-src 'self';script-src 'self' 'sha256-muinbbhYT4ByGcX7i9h85DyS1kl3Gt7qraXrucPlmEA=' paypal.com *.paypal.com;style-src 'self' 'sha256-E8i90CPMj/1skOQSbTtp7WVj8MXSEtEozJYId0/hMkY=' fontawesome.com *.fontawesome.com fonts.google.com  *.fonts.google.com fonts.googleapis.com *.fonts.googleapis.com;"
  );
  next();
});
